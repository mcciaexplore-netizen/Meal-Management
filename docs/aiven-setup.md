...
Choose the transfer procedure after reviewing both schemas. Do not initialize tables in a destination intended for a full schema-and-data restore. The repository currently contains migrations 001 through 009; actual pending migrations require live inspection.
