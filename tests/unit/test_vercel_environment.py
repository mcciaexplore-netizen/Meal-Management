...
SENSITIVE_KEYS = {"DB_PASSWORD", "QR_ENCRYPTION_KEYS", "APP_CSRF_SECRET", "LOGIN_RATE_SECRET", "GMAIL_APP_PASSWORD"}
EXPECTED_KEYS = {
    ...
    "EMAIL_AUTO_SEND_ENABLED", "EMAIL_PROCESS_LIMIT", "SCAN_APP_ENABLED", "SCANNER_ALLOWED_CIDRS",
